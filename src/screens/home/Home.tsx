  ...
  const guidanceVideos = [
    {
      ...
      duration: '1:31',
      onPress: () => Linking.openURL('https://youtu.be/-XI7kob-nls'),
    },
    {
      id: '2',
      title: 'What is Bedwetting?',
      duration: '3:21',
      onPress: () => Linking.openURL('https://youtu.be/ifEvP-rbn1Y'),
    },
    {
      id: '3',
      title: 'How to Use the Numah.AI App',
      duration: '0:50',
      onPress: () => Linking.openURL('https://youtu.be/TPVCHB68yc4'),
    },
    {
      id: '4',
    ...
    },
    {
      ...
      duration: '1:50',
      onPress: () => Linking.openURL('https://youtu.be/uv7EBSyg-o4'),
    },
    {
      id: '10',
      title: 'Bedwetting & ADHD: What You Should Know',
      duration: '0:42',
      onPress: () => Linking.openURL('https://youtu.be/W8KZEuFg9-E'),
    },
    {
      id: '11',
      title: 'Troubleshooting: Sensor Issues',
      duration: '0:36',
      onPress: () => Linking.openURL('https://youtu.be/lPeqkVAOjVg'),
    },
  ];
